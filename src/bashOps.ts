...
function windowsBashExecutable(): string | undefined {
  ...
  const fixedCandidates = [
    ...
    process.env.CYGWIN_BASH,
    process.env.ProgramW6432 ? path.join(process.env.ProgramW6432, "Git", "bin", "bash.exe") : undefined,
    process.env.ProgramW6432 ? path.join(process.env.ProgramW6432, "Git", "usr", "bin", "bash.exe") : undefined,
    ...
    process.env["ProgramFiles(x86)"] ? path.join(process.env["ProgramFiles(x86)"], "Git", "usr", "bin", "bash.exe") : undefined,
    process.env.USERPROFILE ? path.join(process.env.USERPROFILE, "scoop", "apps", "git", "current", "bin", "bash.exe") : undefined,
    process.env.USERPROFILE ? path.join(process.env.USERPROFILE, "scoop", "apps", "git", "current", "usr", "bin", "bash.exe") : undefined
  ];
...
function bashExecutable(): string {
  if (process.platform === "win32") {
    return windowsBashExecutable() ?? "bash";
  }
