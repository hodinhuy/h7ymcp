...
export async function buildProContext(
  ...
  const title = options.title?.trim() || "H7Y MCP Context Bundle";
  ...
  parts.push(
    [
      ...
      "",
      "Purpose: paste this bundle into a high-context ChatGPT model when that model cannot call the H7Y MCP tools directly.",
